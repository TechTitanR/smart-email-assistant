...
def main():
    parser = argparse.ArgumentParser(description='Smart Email Assistant (simple offline)')
    ...
    if args.file:
        ...
        print("Please provide --file or --text. Example: python3 main.py --file samples/email1.txt")
        return 1
